          ...
          <form>
            <div className="grid grid-cols-3 gap-5 justify-normal">
              ...
              <div className="form-group w-full col-span-3">
                ...
                <select
                  className="w-full rounded border border-stroke py-3 px-4.5 text-black dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                  name="type"
                  onChange={handleChange}
              ...
              {errors.length > 0 && (
                <div className="w-full col-span-3 mt-4 text-red-600">
                  <ul>
            ...
            <div className="w-full mt-4 flex justify-center">
              <button
                type="submit"
                className="flex h-12 w-full items-center justify-center rounded bg-primary px-6 text-base font-medium text-white"
