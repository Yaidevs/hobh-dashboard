    ...
    <div className="relative flex">
      ...
      >
        ...
        <button className="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm hover:bg-gray dark:hover:bg-meta-4">
          ...
          >
            <path
              d="M12.225 2.20005H10.3V1.77505C10.3 1.02505 9.70005 0.425049 8.95005 0.425049H7.02505C6.27505 0.425049 5.67505 1.02505 5.67505 1.77505V2.20005H3.75005C3.02505 2.20005 2.42505 2.80005 2.42505 3.52505V4.27505C2.42505 4.82505 2.75005 5.27505 3.22505 5.47505L3.62505 13.75C3.67505 14.775 4.52505 15.575 5.55005 15.575H10.4C11.425 15.575 12.275 14.775 12.325 13.75L12.75 5.45005C13.225 5.25005 13.55 4.80005 13.55 4.27505V3.52505C13.55 2.80005 12.950 2.20005 12.225 2.20005ZM7.02505 1.77505H8.95005V2.20005H7.02505V1.77505ZM12.225 3.52505C12.225 3.27505 12.025 3.07505 11.775 3.07505H3.22505C2.97505 3.07505 2.77505 3.27505 2.77505 3.52505V4.27505C2.77505 4.52505 2.97505 4.72505 3.22505 4.72505H12.225C12.475 4.72505 12.675 4.52505 12.675 4.27505V3.52505H12.225ZM6.52505 12.775C6.52505 12.525 6.72505 12.325 6.97505 12.325H9.02505C9.27505 12.325 9.47505 12.525 9.47505 12.775V13.525C9.47505 13.775 9.27505 13.975 9.02505 13.975H6.97505C6.72505 13.975 6.52505 13.775 6.52505 13.525V12.775Z"
            />
          </svg>
          Delete
        </button>
