...
import { useGetAllItemQuery } from "../api/dataApi";

const packageData = [
  {
    user: "John Doe",
    amount: 3000,
    transactionId: `xn_1AbCdE2FgHiJkL`,
    status: "Inactive",
    image: "https://image.codkk",
  },
  {
    user: "John Doe",
    amount: 3000,
...
const TransactionTable = () => {
  const { data: transactions, isSuccess } = useGetAllItemQuery();
  ...
  const totalPages =
    transactions && transactions.data
      ? Math.ceil(transactions.data.length / itemsPerPage)
      : 0;
    ...
    <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      ...
      <div className="flex justify-between items-center mt-4">
        <div>
          ...
          {Math.min(indexOfLastTransaction, transactions?.data.length)} of{" "}
